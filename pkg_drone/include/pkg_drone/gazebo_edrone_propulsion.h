...
#include "pkg_drone/prop_speed.h"
...
/*
  This is a Plugin that is used with pkg_drone
...
class ModelJointControler : public ModelPlugin
{
  ...
  private: void OnRosMsg_prop_speed(const pkg_drone::prop_speedConstPtr &_msg);
  ...
  private: pkg_drone::prop_speed force_msg_;
  private: pkg_drone::prop_speed temp_msg_;
